...
An ordinary metadata-routed `fm-send.sh` text steer becomes a durable steering-inbox record, and only its best-effort doorbell passes through Orca's submit machinery; watcher re-rings append elapsed time.
