...
# time or this cadence bound, whichever comes first. Both consumers resolve
# FM_PAUSE_RESURFACE_SECS against this default through fm_watch_threshold below,
# so the cadence has one owner. An item held for the captain is not rechecked at all
