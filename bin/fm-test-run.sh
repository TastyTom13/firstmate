...
family_for_basename() {
  case "$1" in
    ...
    fm-tool-update-check.test.sh|fm-hp-runner-check.test.sh|\
...
tests/fm-backlog-read-bound.test.sh 29978
tests/fm-bearings-board-lavish-live-e2e.test.sh 18450
tests/fm-bearings-board-render.test.sh 1528
tests/fm-bearings-board.test.sh 4195
tests/fm-bearings-idea-capture.test.sh 260
...
tests/fm-calm-claude-mod-live-e2e.test.sh 118
tests/fm-calm-claude-mod-plugin.test.sh 2152
tests/fm-calm-claude-mod.test.sh 1808
tests/fm-calm-pi-extension.test.sh 256
tests/fm-check-unregister.test.sh 481
tests/fm-chrome-bridge-sweep.test.sh 16754
tests/fm-ci-workflow.test.sh 1073
...
tests/fm-claude-trust.test.sh 17911
tests/fm-cmux-claude-composer-live-e2e.test.sh 23
tests/fm-codex-continuity-live-e2e.test.sh 21
tests/fm-composer-codex-idle-live-e2e.test.sh 161
tests/fm-composer-matrix-live-e2e.test.sh 23
tests/fm-context-budget.test.sh 5369
tests/fm-contributions.test.sh 49494
...
tests/fm-env-sync.test.sh 6264
tests/fm-evidence-only-finding.test.sh 1118
...
tests/fm-free-lane-slim-prompt-live-e2e.test.sh 1299
tests/fm-free-tier-guard.test.sh 912
tests/fm-gate-refuse.test.sh 4977
tests/fm-gemini-harness.test.sh 1636
...
tests/fm-harness-precedence.test.sh 7494
tests/fm-herdr-attached-viewer-live-e2e.test.sh 19000
tests/fm-herdr-pi-stale-registration-live-e2e.test.sh 6488
...
tests/fm-mail-check.test.sh 9907
tests/fm-mail.test.sh 11693
tests/fm-model-scorecard.test.sh 672
tests/fm-muse-harness.test.sh 55572
tests/fm-muse-signals-live-e2e.test.sh 23
tests/fm-nm-test-contract.test.sh 363
tests/fm-no-mistakes-required.test.sh 370
tests/fm-omp-harness.test.sh 59969
tests/fm-omp-primary-live-e2e.test.sh 206
...
tests/fm-pi-codex-native.test.sh 170
...
tests/fm-pr-reviewers.test.sh 792
tests/fm-pr-state-live-e2e.test.sh 163
tests/fm-pr-state.test.sh 1258
...
tests/fm-quota-sampler.test.sh 1332
...
tests/fm-rovo-harness.test.sh 21488
tests/fm-rovo-signals-live-e2e.test.sh 200
...
tests/fm-send-agy-confirm.test.sh 5381
...
tests/fm-spawn-free-lane.test.sh 24058
tests/fm-spawn-pi-node.test.sh 15907
...
tests/fm-stat-shadowing.test.sh 674
...
tests/fm-tasks-axi.test.sh 2214
...
tests/fm-usage-history.test.sh 3742
...
tests/fm-watch-thresholds.test.sh 653
