...
family_for_basename() {
  case "$1" in
    ...
    fm-free-lane-run.test.sh|fm-free-tier-guard.test.sh|fm-grok-harness.test.sh|\
    ...
    fm-evidence-only-finding.test.sh|\
    ...
    fm-free-lane-slim-prompt-live-e2e.test.sh|\
...
portable_serial_weight_hints() {
  cat <<'EOF'
tests/fm-afk-inject-e2e.test.sh 35118
tests/fm-afk-pi-herdr-return-e2e.test.sh 69
tests/fm-afk-return.test.sh 2296
tests/fm-ask-user-authority.test.sh 137
tests/fm-backend-cmux-smoke.test.sh 35
tests/fm-backend-cmux.test.sh 3523
tests/fm-backend-herdr-focus-flash-e2e.test.sh 24
tests/fm-backend-orca.test.sh 18326
tests/fm-backend-tmux-smoke.test.sh 332
tests/fm-backend-zellij-smoke.test.sh 21
tests/fm-backend-zellij.test.sh 10940
tests/fm-backend.test.sh 19496
tests/fm-backlog-atomicity.test.sh 117528
tests/fm-backlog-handoff.test.sh 50868
tests/fm-bearings-board-render.test.sh 2835
tests/fm-bearings-board.test.sh 4607
tests/fm-bearings-snapshot.test.sh 80521
tests/fm-bootstrap-network-parallel.test.sh 8099
tests/fm-bootstrap.test.sh 23754
tests/fm-branch-supervision.test.sh 5759
tests/fm-busy-adapter-wiring.test.sh 17704
tests/fm-busy-state.test.sh 2978
tests/fm-calm-pi-extension.test.sh 225
tests/fm-check-unregister.test.sh 451
tests/fm-classify-corr-token.test.sh 43869
tests/fm-classify-decision-key.test.sh 1262
tests/fm-claude-stop-autoarm-live-e2e.test.sh 21
tests/fm-claude-stop-autoarm.test.sh 60661
...
tests/fm-control-relaunch.test.sh 48252
tests/fm-control.test.sh 37096
tests/fm-cursor-harness.test.sh 30098
tests/fm-cursor-primary-live-e2e.test.sh 22
tests/fm-cursor-primary.test.sh 52379
tests/fm-daemon.test.sh 26083
tests/fm-documentation-audiences.test.sh 722
...
tests/fm-gotmp.test.sh 1240
tests/fm-gpt-quota.test.sh 1188
tests/fm-grok-continuity-live-e2e.test.sh 18
tests/fm-grok-stop-live-e2e.test.sh 20
tests/fm-guard-stale-banner.test.sh 10891
...
tests/fm-herdr-session-cleanup.test.sh 6127
tests/fm-herdr-submit-confirm-live-e2e.test.sh 21
tests/fm-herdr-version-floor-live-e2e.test.sh 22
tests/fm-home-summary-refresh.test.sh 33341
tests/fm-inactive-reconcile.test.sh 41517
tests/fm-kimi-harness.test.sh 17460
tests/fm-lint-workflows.test.sh 800
tests/fm-muse-harness.test.sh 55289
tests/fm-muse-signals-live-e2e.test.sh 24
tests/fm-no-mistakes-required.test.sh 626
tests/fm-on.test.sh 11094
tests/fm-opencode-primary-live-e2e.test.sh 19
tests/fm-operational-input.test.sh 222
tests/fm-peek-remote.test.sh 887
tests/fm-pending-reply.test.sh 28571
tests/fm-pi-branch-extension.test.sh 21457
tests/fm-pi-branch-live-e2e.test.sh 20
tests/fm-pi-primary-live-e2e.test.sh 20
tests/fm-pi-watch-extension.test.sh 42279
tests/fm-pr-check-security.test.sh 153007
tests/fm-procevent-quota.test.sh 1817
tests/fm-procevent-when.test.sh 17559
tests/fm-procevent.test.sh 69960
tests/fm-project-origin.test.sh 106
tests/fm-public-followup.test.sh 196356
tests/fm-quota-array-dispatch-live-e2e.test.sh 20
tests/fm-quota-choose.test.sh 5992
tests/fm-quota-pools.test.sh 776
tests/fm-remote-backlog-handoff.test.sh 39577
tests/fm-remote-doctor.test.sh 5505
tests/fm-remote-entrypoint.test.sh 139
tests/fm-remote-job-orphan-reap.test.sh 2933
tests/fm-remote-job.test.sh 59679
tests/fm-remote-reply.test.sh 102382
tests/fm-remote-secondmate-lifecycle-e2e.test.sh 212368
tests/fm-remote-secondmate-parent-binding.test.sh 28780
tests/fm-remote-secondmate-trace-context.test.sh 67712
tests/fm-remote-transport-lanes.test.sh 63878
tests/fm-secondmate-harness.test.sh 145449
tests/fm-secondmate-lifecycle-e2e.test.sh 9881
tests/fm-secondmate-liveness.test.sh 17476
tests/fm-secondmate-reconcile.test.sh 59586
tests/fm-secondmate-safety.test.sh 54706
tests/fm-secondmate-sync.test.sh 17176
tests/fm-send-inbox-doorbell-live-e2e.test.sh 32
tests/fm-send-inbox.test.sh 38080
tests/fm-send-remote-delivery.test.sh 26096
tests/fm-send-resolve-key.test.sh 20273
tests/fm-send-secondmate-marker-herdr-e2e.test.sh 77
tests/fm-send-secondmate-marker.test.sh 5589
tests/fm-session-lock-ancestry.test.sh 1288
tests/fm-session-start.test.sh 154693
tests/fm-sessionstart-hook-live-e2e.test.sh 19
tests/fm-sessionstart-instruction-refresh-live-e2e.test.sh 20
tests/fm-sessionstart-nudge.test.sh 63621
tests/fm-shared-captain-inheritance.test.sh 5770
tests/fm-spawn-dispatch-profile.test.sh 63114
tests/fm-spawn-pool-base-freshen.test.sh 34279
tests/fm-spawn-worktree-settle.test.sh 5623
tests/fm-startup-memory-budget.test.sh 6709
tests/fm-startup-network.test.sh 54403
tests/fm-stow-cascade.test.sh 2973
tests/fm-subagent-pretool-check.test.sh 948
tests/fm-supervision-events.test.sh 770
tests/fm-tangle-guard.test.sh 9120
tests/fm-task-delivery.test.sh 6640
tests/fm-task-inbox.test.sh 25512
tests/fm-teardown-endpoint-safety.test.sh 4549
tests/fm-teardown.test.sh 93093
tests/fm-test-fixture-cleanup.test.sh 884
tests/fm-test-fixtures.test.sh 143
tests/fm-test-isolation-proof.test.sh 2390
tests/fm-tmux-agent-liveness.test.sh 1414
tests/fm-tool-update-check.test.sh 14606
tests/fm-trace-context-lib.test.sh 240
tests/fm-trace-context-spawn.test.sh 43649
tests/fm-turnend-guard.test.sh 41678
tests/fm-update.test.sh 4891
tests/fm-vendor-auth-probe.test.sh 43228
tests/fm-voice-relay.test.sh 28630
tests/fm-wake-daemon-lifecycle-e2e.test.sh 7108
tests/fm-wake-drain-open-decisions-cursor.test.sh 21043
tests/fm-wake-drain-open-decisions.test.sh 5703
tests/fm-wake-drain-unread-status.test.sh 34642
tests/fm-wake-queue.test.sh 48434
tests/fm-watch-arm.test.sh 52400
tests/fm-watch-checkpoint.test.sh 6125
tests/fm-watch-recovery-loop.test.sh 58661
tests/fm-watch-triage.test.sh 247587
tests/fm-watcher-lock.test.sh 60703
EOF
}
