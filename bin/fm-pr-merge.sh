...
#
# Usage: fm-pr-merge.sh <task-id> <pr-url> [--expect-base <branch>] [--attended-override] [--allow-red <check-name>] [-- <extra forge merge args>]
#
...
# --expect-base, --attended-override, and --allow-red are this script's own
# arguments, never forge merge arguments, so they are consumed before the '--'
# separator hands the rest to the forge CLI.
EXPECT_BASE=
EXPECT_BASE_SET=0
