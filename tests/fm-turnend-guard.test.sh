...
install_guard_scripts() {
  ...
  chmod +x "$dir/bin/fm-turnend-guard.sh" "$dir/bin/fm-context-budget.sh" "$dir/bin/fm-turnend-guard-grok.sh" "$dir/bin/fm-operational-input.sh" "$dir/bin/fm-supervision-instructions.sh" "$dir/bin/fm-harness.sh"
}
