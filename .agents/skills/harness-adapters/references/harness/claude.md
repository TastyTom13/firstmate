...
| `opus` alias | Resolves to Opus 5.5 as of 2026-09-25; Anthropic reports that Opus 5.5 at `medium` matches Opus 5 at `high` with fewer tokens, so effort names are not comparable across the two models. |
